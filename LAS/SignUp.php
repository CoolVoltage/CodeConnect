...
var url="LAS/DBsubmit.php?Nick="+document.getElementById("RNick").value+"&Email="+document.getElementById("REmail").value+"&Pass="+document.getElementById("RPass").value+"&RePass="+document.getElementById("RRepass").value;
...
if (request.readyState == 4) {
	...
	document.getElementById('SignUp').style.display="none";
				...
				for (i=0;i<(input_tags-2);++i) {
				input_tags[i].onblur();
				drawCanvas();
}
				input_tags[input_tags.length-2].value="";
}
		}
		}	
};
